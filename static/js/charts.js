...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var filterSample = samples.filter(sampleValue => sampleValue.id == sample) 
    ...
    var barData = {
      ...
      y: yticks,
      hover: otuLabels.slice(0,10).reverse(),
      type: "bar",
      orientation: "h"
    };
    ...
    Plotly.newPlot('bar',[barData],barLayout)
        ...
        var metadata = data.metadata.filter(sampleValue => sampleValue.id == sample);
